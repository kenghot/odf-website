...
interface IIncompletePersonalRequestReport
...
@observer
class IncompletePersonalRequestReport extends React.Component<
  IIncompletePersonalRequestReport
> {
  ...
  public render() {
    ...
    return (
      <ReportCard
        title={t("module.report.IncompletePersonalRequestReport.title")}
        filter={
  ...
  private onGetReport = async () => {
    ...
    try {
      await Request.get(
        ...
        { name: "printIncompletePersonalRequestReport" }
      );
    } catch (e) {
...
export default withRouter(withTranslation()(IncompletePersonalRequestReport));
