...
interface IVisitReport extends WithTranslation, RouteComponentProps {
  appStore?: IAppModel;
...
@inject("appStore")
@observer
class VisitReport extends React.Component<IVisitReport> {
  ...
  public render() {
    ...
    return (
      <ReportCard
        title={t("module.report.VisitReport.title")}
        filter={
  ...
  private onGetReport = async () => {
    ...
    try {
      ...
      // await fetchNoService(`${reportUrl}/report_07.php`, {
...
export default withRouter(withTranslation()(VisitReport));
