...
interface IRequestResultReport extends WithTranslation, RouteComponentProps {
...
@inject("appStore")
@observer
class RequestResultReport extends React.Component<IRequestResultReport> {
  public state = {
    fiscalYear: "",
    region: "",
    organizationId: "",
  ...
  public render() {
    ...
    return (
      <ReportCard
        title={t("module.report.RequestResultReport.title")}
        filter={
            ...
            <Grid.Column width={16}>
              <Form.Field
                ...
                idInputFieldNameStartDate={
                  "RequestResultReportStartDocumentDate"
                }
...
export default withRouter(withTranslation()(RequestResultReport));
