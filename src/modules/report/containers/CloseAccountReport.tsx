...
interface ICloseAccountReport extends WithTranslation, RouteComponentProps {
...
@inject("appStore")
@observer
class CloseAccountReport extends React.Component<ICloseAccountReport> {
  public state = {
    fiscalYear: "",
    region: "",
    organizationId: "",
  ...
  public render() {
    ...
    return (
      <ReportCard
        title={t("module.report.CloseAccountReport.title")}
        filter={
...
export default withRouter(withTranslation()(CloseAccountReport));
