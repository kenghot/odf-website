...
interface IDonationAllowancesSummarize
...
@inject("appStore")
@observer
class DonationAllowancesSummarize extends React.Component<IDonationAllowancesSummarize> {
  ...
  public render() {
    ...
    return (
      <ReportCard
        title={t("page.DonationReportListPage.report06")}
        filter={
          <Grid columns={"equal"} doubling stackable>
            ...
            required
                ...
                id={"DonationAllowancesSummarizeReportMonth"}
              />
            </Grid.Column>
            <Grid.Column>
            <Form.Input
...
export default withRouter(withTranslation()(DonationAllowancesSummarize));
