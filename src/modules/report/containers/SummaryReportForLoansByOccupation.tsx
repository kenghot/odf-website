...
interface ISummaryReportForLoansByOccupation extends WithTranslation, RouteComponentProps {
  appStore?: IAppModel;
...
@inject("appStore")
@observer
class SummaryReportForLoansByOccupation extends React.Component<ISummaryReportForLoansByOccupation> {
  ...
  public render() {
    ...
    return (
      <ReportCard
        title={t("module.report.SummaryReportForLoansByOccupation.title")}
        filter={
  ...
  private onGetReport = async () => {
    ...
    try {
      ...
      //   { name: "report_09.php" }
      // );
      await fetchNoService(`${reportUrl}/report_09.php`, {
        // the_year: this.state.fiscalYear || "0",
...
export default withRouter(withTranslation()(SummaryReportForLoansByOccupation));
