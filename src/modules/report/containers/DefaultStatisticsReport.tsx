...
interface IDefaultStatisticsReport extends WithTranslation, RouteComponentProps {
  appStore?: IAppModel;
...
@inject("appStore")
@observer
class DefaultStatisticsReport extends React.Component<IDefaultStatisticsReport> {
  ...
  public render() {
    ...
    return (
      <ReportCard
        title={t("module.report.DefaultStatisticsReport.title")}
        filter={
  ...
  private onGetReport = async () => {
    ...
    try {
      ...
      await DebtCollection.get(
        ...
        { name: "printPrescriptionReport" }
      );
      // await fetchNoService(`${reportUrl}/report_08.php`, {
      //   // the_year: this.state.fiscalYear || "0",
...
export default withRouter(withTranslation()(DefaultStatisticsReport));
