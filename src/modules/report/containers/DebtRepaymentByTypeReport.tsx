...
import { OfficePaymentMethodDDL } from "../../../components/payment";
...
interface IDebtRepaymentByTypeReport extends WithTranslation, RouteComponentProps {
...
@inject("appStore")
@observer
class DebtRepaymentByTypeReport extends React.Component<IDebtRepaymentByTypeReport> {
  public state = {
    officePaymentMethod: "",
    organizationId: "",
    startDocumentDate: "",
  ...
  public render() {
    ...
    return (
      <ReportCard
        title={t("module.report.DebtRepaymentByTypeReport.title")}
        filter={
          <Grid columns={"equal"} doubling stackable>
            ...
            <Grid.Column width={16}>
              <Form.Field
                ...
                idInputFieldNameStartDate={"ReceiptReport1StartDocumentDate"}
                inputFieldNameStartDate="startDocumentDate"
                idInputFieldNameEndDate={"ReceiptReport1EndDocumentDate"}
  ...
  private onGetReport = async () => {
    ...
    try {
      ...
      // window.open(FILES_PATH.debtRepaymentByTypeReport);
      await Receipt.get(
        {
...
export default withRouter(withTranslation()(DebtRepaymentByTypeReport));
