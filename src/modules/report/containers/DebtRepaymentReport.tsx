...
interface IDebtRepaymentReport extends WithTranslation, RouteComponentProps {
  appStore?: IAppModel;
...
@inject("appStore")
@observer
class DebtRepaymentReport extends React.Component<IDebtRepaymentReport> {
  ...
  public render() {
    ...
    return (
      <ReportCard
        title={t("module.report.DebtRepaymentReport.title")}
        filter={
  ...
  private onGetReport = async () => {
    ...
    try {
      await DebtCollection.get(
        ...
        { name: "printDebtRepaymentReport" }
      );
      // await fetchNoService(`${reportUrl}/report_02.php`, {
...
export default withRouter(withTranslation()(DebtRepaymentReport));
