...
export const PosShiftModel = types
  .model("PosShiftModel", {
    ...
    transactionTransferCount: customtypes.optional(types.string, ""),
    transactionTransferAmount: customtypes.optional(types.string, ""),
    ...
    transactionCancelCount: customtypes.optional(types.string, ""),
    transactionCancelAmount: customtypes.optional(types.string, ""),
