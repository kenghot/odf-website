...
interface IOrganizationDDL extends WithTranslation {
...
@observer
class OrganizationDDL extends React.Component<IOrganizationDDL> {
  ...
  public render() {
    ...
    return (
      <Dropdown
        ...
        fluid
        multiple={multiple}
        options={orgList!.list.map((a) => a.listitem)}
...
export default withTranslation()(OrganizationDDL);
