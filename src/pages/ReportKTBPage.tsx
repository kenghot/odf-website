...
} from "../modules/report/ktb";
interface IReportKTBListPage extends WithTranslation, RouteComponentProps {
  appStore?: IAppModel;
}

@inject("appStore")
@observer
class ReportKTBListPage extends React.Component<IReportKTBListPage> {
...
export default withRouter(withTranslation()(ReportKTBListPage));
