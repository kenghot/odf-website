...
interface IDonationInfoModal extends WithTranslation {
  trigger?: any;
  id?: string;
}

@observer
class DonationInfoModal extends React.Component<IDonationInfoModal> {
  public state = {
    open: false
  };
...
export default withTranslation()(DonationInfoModal);
